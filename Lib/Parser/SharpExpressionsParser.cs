...
// $ANTLR 3.5.0.2 C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g 2015-07-06 01:46:09
...
public partial class SharpExpressionsParser : Antlr.Runtime.Parser
{
		...
		try
		{
			...
			while (true)
			{
				...
				case 2:
					...
					{
					DebugLocation(25, 4);
					Match(input,29,Follow._29_in_boolean_expression119); 
					DebugLocation(25, 11);
		...
		try
		{
			...
			while (true)
			{
				...
				case 1:
					...
					{
					DebugLocation(52, 7);
					Match(input,26,Follow._26_in_power_expression346); 
					DebugLocation(52, 13);
	...
	// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:61:1: atomic_expression returns [Queue ret] : (n= REAL |n= QUOTED_STRING |Q= boolean_terminal |Q1= identifier_expression (Q2= fn_call |Q2= array_access )? | '(' Q= expression ')' );
	...
	private Queue atomic_expression()
	{
		...
		try
		{
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:62:3: (n= REAL |n= QUOTED_STRING |Q= boolean_terminal |Q1= identifier_expression (Q2= fn_call |Q2= array_access )? | '(' Q= expression ')' )
			int alt8=5;
			...
			case 4:
				DebugEnterAlt(4);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:65:5: Q1= identifier_expression (Q2= fn_call |Q2= array_access )?
				{
				DebugLocation(65, 7);
				...
				DebugLocation(65, 30);
				 ret=Q1; 
				DebugLocation(65, 47);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:65:47: (Q2= fn_call |Q2= array_access )?
				int alt7=3;
				...
				case 2:
					DebugEnterAlt(2);
					// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:66:48: Q2= array_access
					{
					DebugLocation(66, 50);
					PushFollow(Follow._array_access_in_atomic_expression509);
					Q2=array_access();
					PopFollow();
			...
			case 5:
				DebugEnterAlt(5);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:67:5: '(' Q= expression ')'
				{
				DebugLocation(67, 5);
				Match(input,11,Follow._11_in_atomic_expression519); 
				DebugLocation(67, 10);
				PushFollow(Follow._expression_in_atomic_expression523);
				Q=expression();
				PopFollow();

				DebugLocation(67, 22);
				Match(input,12,Follow._12_in_atomic_expression525); 
				DebugLocation(67, 26);
				 ret=Q; 
	...
	// $ANTLR start "fn_call"
	// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:74:1: fn_call returns [Queue ret] : '(' Q= list_of_expressions ')' ;
	[GrammarRule("fn_call")]
	private Queue fn_call()
	{
		...
		try
		{
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:75:3: ( '(' Q= list_of_expressions ')' )
			DebugEnterAlt(1);
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:75:5: '(' Q= list_of_expressions ')'
			{
			DebugLocation(75, 5);
			Match(input,11,Follow._11_in_fn_call569); 
			DebugLocation(75, 10);
			PushFollow(Follow._list_of_expressions_in_fn_call573);
			Q=list_of_expressions();
			PopFollow();

			DebugLocation(75, 31);
			Match(input,12,Follow._12_in_fn_call575); 
			DebugLocation(75, 35);
			 ret=Q; 
	...
	// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:78:1: list_of_expressions returns [Queue ret] : (Q1= expression ( ',' Q2= expression )* |);
	...
	private Queue list_of_expressions()
	{
		...
		try
		{
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:79:3: (Q1= expression ( ',' Q2= expression )* |)
			int alt10=2;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:79:5: Q1= expression ( ',' Q2= expression )*
				{
				DebugLocation(79, 7);
				PushFollow(Follow._expression_in_list_of_expressions596);
				Q1=expression();
				PopFollow();
				...
				DebugLocation(79, 19);
				 ret=Q1; 
				DebugLocation(79, 36);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:79:36: ( ',' Q2= expression )*
				...
				while (true)
				{
					...
					case 1:
						DebugEnterAlt(1);
						// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:79:37: ',' Q2= expression
						{
						DebugLocation(79, 37);
						Match(input,15,Follow._15_in_list_of_expressions601); 
						DebugLocation(79, 43);
						PushFollow(Follow._expression_in_list_of_expressions605);
						Q2=expression();
						PopFollow();
			...
			case 2:
				DebugEnterAlt(2);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:80:5: 
				{
				DebugLocation(80, 5);
				 ret=empty_queue(); 
	...
	// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:83:1: identifier_expression returns [Queue ret] : a= IDENTIFIER ( '.' b= IDENTIFIER )* ;
	...
	private Queue identifier_expression()
	{
		...
		try
		{
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:84:3: (a= IDENTIFIER ( '.' b= IDENTIFIER )* )
			DebugEnterAlt(1);
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:84:5: a= IDENTIFIER ( '.' b= IDENTIFIER )*
			{
			DebugLocation(84, 6);
			a=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_identifier_expression634); 
			DebugLocation(84, 18);
			 ret=push_identifier(empty_queue(), (a!=null?a.Text:default(string))); 
			DebugLocation(84, 67);
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:84:67: ( '.' b= IDENTIFIER )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:84:68: '.' b= IDENTIFIER
					{
					DebugLocation(84, 68);
					Match(input,17,Follow._17_in_identifier_expression639); 
					DebugLocation(84, 73);
					b=(IToken)Match(input,IDENTIFIER,Follow._IDENTIFIER_in_identifier_expression643); 
					DebugLocation(84, 85);
	...
	// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:87:1: boolean_terminal returns [Queue ret] : ( 'true' | 'false' );
	...
	private Queue boolean_terminal()
	{
		...
		try
		{
			// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:88:3: ( 'true' | 'false' )
			int alt12=2;
			...
			case 1:
				DebugEnterAlt(1);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:88:5: 'true'
				{
				DebugLocation(88, 5);
				Match(input,28,Follow._28_in_boolean_terminal664); 
				DebugLocation(88, 12);
			...
			case 2:
				DebugEnterAlt(2);
				// C:\\workspace\\SharpExpressions\\Lib\\\\Parser\\SharpExpressions.g:89:5: 'false'
				{
				DebugLocation(89, 5);
				Match(input,27,Follow._27_in_boolean_terminal672); 
				DebugLocation(89, 13);
	...
	private static class Follow
	{
		...
		public static readonly BitSet _comparison_in_boolean_expression98 = new BitSet(new ulong[]{0x20000402UL});
		public static readonly BitSet _10_in_boolean_expression108 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _comparison_in_boolean_expression112 = new BitSet(new ulong[]{0x20000402UL});
		public static readonly BitSet _29_in_boolean_expression119 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _comparison_in_boolean_expression123 = new BitSet(new ulong[]{0x20000402UL});
		public static readonly BitSet _addition_expression_in_comparison146 = new BitSet(new ulong[]{0xF80202UL});
		public static readonly BitSet _23_in_comparison156 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _addition_expression_in_comparison160 = new BitSet(new ulong[]{0xF80202UL});
		public static readonly BitSet _22_in_comparison167 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _addition_expression_in_comparison172 = new BitSet(new ulong[]{0xF80202UL});
		public static readonly BitSet _20_in_comparison179 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _addition_expression_in_comparison183 = new BitSet(new ulong[]{0xF80202UL});
		public static readonly BitSet _19_in_comparison190 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _addition_expression_in_comparison195 = new BitSet(new ulong[]{0xF80202UL});
		public static readonly BitSet _21_in_comparison202 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _addition_expression_in_comparison206 = new BitSet(new ulong[]{0xF80202UL});
		public static readonly BitSet _9_in_comparison213 = new BitSet(new ulong[]{0x18010970UL});
		...
		public static readonly BitSet _14_in_addition_expression250 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _multiply_expression_in_addition_expression254 = new BitSet(new ulong[]{0x14002UL});
		public static readonly BitSet _16_in_addition_expression261 = new BitSet(new ulong[]{0x18010970UL});
		...
		public static readonly BitSet _13_in_multiply_expression298 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _power_expression_in_multiply_expression302 = new BitSet(new ulong[]{0x42002UL});
		public static readonly BitSet _18_in_multiply_expression309 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _power_expression_in_multiply_expression313 = new BitSet(new ulong[]{0x42002UL});
		public static readonly BitSet _negation_in_power_expression336 = new BitSet(new ulong[]{0x4000002UL});
		public static readonly BitSet _26_in_power_expression346 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _negation_in_power_expression350 = new BitSet(new ulong[]{0x4000002UL});
		public static readonly BitSet _16_in_negation372 = new BitSet(new ulong[]{0x18000870UL});
		public static readonly BitSet _atomic_expression_in_negation376 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _8_in_negation384 = new BitSet(new ulong[]{0x18000870UL});
		...
		public static readonly BitSet _identifier_expression_in_atomic_expression449 = new BitSet(new ulong[]{0x1000802UL});
		public static readonly BitSet _fn_call_in_atomic_expression456 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _array_access_in_atomic_expression509 = new BitSet(new ulong[]{0x2UL});
		...
		public static readonly BitSet _12_in_fn_call575 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _expression_in_list_of_expressions596 = new BitSet(new ulong[]{0x8002UL});
		public static readonly BitSet _15_in_list_of_expressions601 = new BitSet(new ulong[]{0x18010970UL});
		public static readonly BitSet _expression_in_list_of_expressions605 = new BitSet(new ulong[]{0x8002UL});
		public static readonly BitSet _IDENTIFIER_in_identifier_expression634 = new BitSet(new ulong[]{0x20002UL});
		public static readonly BitSet _17_in_identifier_expression639 = new BitSet(new ulong[]{0x10UL});
		public static readonly BitSet _IDENTIFIER_in_identifier_expression643 = new BitSet(new ulong[]{0x20002UL});
		public static readonly BitSet _28_in_boolean_terminal664 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _27_in_boolean_terminal672 = new BitSet(new ulong[]{0x2UL});
	}
